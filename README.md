...
- [WeatherAPI App with Azure SQL Logging](https://github.com/thisislok/thisislok/tree/main/weatherAPI_app)  
  Developed the backend logic connecting **Python with Azure SQL via pyodbc** to log user weather searches, fetching live weather data from WeatherAPI.com and storing search histories for querying.
